          ...
          <form className="space-y-4 md:space-y-6" onSubmit={handleSubmit}>
            ...
            {userRole && userRole !== 'admin' && (
              <p className="text-sm font-light text-gray-500">
                Don’t have an account yet? <a href={userRole === 'student' ? '/auth/register/student' : userRole === 'employer' ? '/auth/register/employer' : '#'} className="font-medium text-primary-600 hover:underline">Sign Up</a>
              </p>
            )}
          </form>
        </div>
