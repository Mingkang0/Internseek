    ...
    <DefaultLayout>
      ...
      <div className='bg-gray-200 px-6 py-8 min-h-screen mx-auto overflow-y-auto lg:py-4'>
        <div className="container mx-auto max-w-3xl p-6 mt-4 bg-white border border-gray-200 rounded-lg shadow">
          ...
          <p className="text-sm text-gray-900 font-semibold">Company Name: {employer?.companyName}</p>
          ...
          <div className='grid grid-cols-3 gap-4 mt-4'>
            ...
            <div className='col-span-1'>
              ...
              <div className='mt-2'>
                ...
                <input type="text" value="Cheras, Kuala Lumpur" className="w-full px-3 py-2 mt-1 border border-gray-300 rounded-md bg-gray-100  shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" disabled />
              </div>
            </div>
            <div className='col-span-1'>
              <div className=''>
