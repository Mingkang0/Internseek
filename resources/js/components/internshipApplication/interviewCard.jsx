          ...
          <div className='flex flex-col lg:flex-row gap-4 mt-2'>
            ...
            {application.ownResume && (
              <div className='flex flex-col Resume'>
                ...
                <a id={`resume-download-${application.student.id}`} href={`/storage/InternshipApplication/documents/ownResume/${application.student.id}/${application.ownResume}`} target="_blank" style={{ display: 'none' }} />
                <button
                  onClick={(e) => {
                    e.preventDefault();
