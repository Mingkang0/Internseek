...
const InterviewCard = ({ application }) => {
  ...
  return (
    <div className="w-full p-5 mt-2 bg-white border border-gray-200 rounded-lg shadow">
      <h5 className="mb-2 text-lg font-bold tracking-tight text-gray-900 flex flex-wrap justify-between">
      ...
      <div className='grid grid-cols-4 lg:grid-cols-12 gap-4'>
        ...
        <div className='col-span-4 lg:col-span-8'>
          <div className='flex flex-col lg:flex-row gap-4'>
            <div className="flex flex-col">
              ...
              <input type="date" className='mt-2 border border-gray-300 bg-gray-100 rounded-lg px-4 py-2 w-full lg:w-40' value={application.expectedStartDate} disabled />
            </div>

            <div className="flex flex-col">
              <label className='text-sm font-semibold text-gray-600'>Expected End Date</label>
              <input type="date" className='mt-2 border border-gray-300 bg-gray-100 rounded-lg px-4 py-2 w-full lg:w-40' value={application.expectedEndDate} disabled />
            </div>

            <div className="flex flex-col">
              <label className='text-sm font-semibold text-gray-600'>Availability</label>
              <input type="text" className='mt-2 border border-gray-300 bg-gray-100 rounded-lg px-4 py-2 w-full lg:w-40' value={`${application.availability} months later`} disabled />
            </div>

            <div className="flex flex-col">
              <label className='text-sm font-semibold text-gray-600'>Expected Allowance</label>
              <input type="text" className='mt-2 border border-gray-300 bg-gray-100 rounded-lg px-4 py-2 w-full lg:w-40' value={`RM ${application.expectedAllowance}`} disabled />
            </div>
          ...
          <div className='flex flex-col lg:flex-row gap-4 mt-2'>
            <div className='flex flex-col transcript'>
              ...
              <button onClick={(e) => { e.preventDefault(); document.getElementById('transcript-download-link').click() }} className='text-sm font-semibold text-white mt-2 bg-blue-800 px-4 py-2 rounded-lg lg:w-40 !important h-10 '>View Transcript</button>
            </div>
            ...
            <div className='flex flex-col SAL'>
              ...
              <button onClick={(e) => { e.preventDefault(); document.getElementById('sal-download-link').click() }} className='text-sm font-semibold text-white mt-2 bg-blue-800 px-4 py-2 rounded-lg lg:w-40 !important h-10'>View SAL</button>
            </div>
            ...
            <div className='flex flex-col CoverLetter'>
              ...
              <button onClick={(e) => { e.preventDefault(); document.getElementById('cover-letter-download-link').click() }} className='text-sm font-semibold text-white mt-2 bg-blue-800 px-4 py-2 rounded-lg lg:w-40 !important h-10'>View Cover Letter</button>
            </div>
            ...
            {application.ownResume && (
              <div className='flex flex-col Resume'>
                ...
                <button onClick={(e) => { e.preventDefault(); document.getElementById('resume-download-link').click() }} className='text-sm font-semibold text-white mt-2 bg-blue-800 px-4 py-2 rounded-lg lg:w-40 !important h-10'>View Resume</button>
              </div>
            )}
          ...
          <div className='flex flex-col lg:flex-row gap-4 mt-2'>
            <div className='flex flex-col'>
              ...
              <input type="date" className='mt-2 border border-gray-300 bg-gray-100 rounded-lg px-4 py-2 lg:w-56' value={application.interview.interviewDate} disabled />
            </div>
            <div className='flex flex-col'>
              <label className='text-sm font-semibold text-gray-600'>Start Time</label>
              <input type="time" className='mt-2 border border-gray-300 bg-gray-100 rounded-lg px-4 py-2 lg:w-56' value={application.interview.interviewStartTime} disabled />
            </div>
            <div className='flex flex-col'>
              <label className='text-sm font-semibold text-gray-600'>End Time</label>
              <input type="time" className='mt-2 border border-gray-300 bg-gray-100 rounded-lg px-4 py-2 lg:w-56' value={application.interview.interviewEndTime} disabled />
            </div>

          </div>
          <div className='flex flex-col lg:flex-row  gap-2 mt-2 lg:gap-8'>
            <div className='flex flex-col'>
              <label className='text-sm font-semibold text-gray-600'>Interview Method</label>
              <input type="text" className='mt-2 border border-gray-300 bg-gray-100 rounded-lg px-4 py-2 lg:w-72' value={application.interview.interviewMethod} disabled />
            </div>
            {application.interview.interviewLocation && (
              <div className='flex flex-col'>
                <label className='text-sm font-semibold text-gray-600'>Interview Location</label>
                <input type="text" className='mt-2 border border-gray-300 bg-gray-100 rounded-lg px-4 py-2 lg:w-96' value={application.interview.interviewLocation} disabled />
              </div>
            )}
            {application.interview.interviewLink && (
              <div className='flex flex-col'>
                <label className='text-sm font-semibold text-gray-600'>Interview Link</label>
                <input type="text" className='mt-2 border border-gray-300 bg-gray-100 rounded-lg px-4 py-2 lg:w-96' value={application.interview.interviewLink} disabled />
              </div>
            )}
          </div>
        ...
        <div className='col-span-4 lg:col-span-2 flex flex-col justify-end gap-2 mt-2 lg:mt-0'>
          {application.interview.interviewStatus === 'Not Available' && (
            <button type='button' onClick={handleEditInterviewDetails} className='flex text-sm justify-center items-center font-semibold text-gray-800 border border-gray-800 bg-white rounded-lg px-4 py-2'><FaPen className='mr-2 mt-1' />Edit Interview Details</button>
          )}
          ...
          <div className='flex gap-2 justify-end'>
            ...
            <p className='text-sm text-gray-800'>{application.employer.firstName} {application.employer.lastName}</p>
          </div>
        </div>
      </div>
