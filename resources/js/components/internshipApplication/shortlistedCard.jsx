...
const ShortlistedOrApprovedApplicantCard = ({ application }) => {
  ...
  const handleUpdate = () => {
    router.get(`/internship-applcations/${application.id}/update-shortlisted-result`)
  }
  ...
  return (
    <div className="w-full p-5 mt-2 bg-white border border-gray-200 rounded-lg shadow">
      ...
      <div className='grid grid-cols-4 lg:grid-cols-12 gap-4'>
        ...
        <div className='col-span-4 lg:col-span-8'>
          ...
          <div className='flex flex-col lg:flex-row gap-2 md:gap-8 mt-2'>
            ...
            <div className='flex flex-col SAL'>
              <label className='text-sm font-semibold text-gray-600'>Application Letter</label>
        ...
        <div className='flex flex-col justify-end gap-2 col-span-4 lg:col-span-2'>
          ...
          {application.applicationStatus === 'Shortlisted' && (
            <button type='button' onClick={handleUpdate} className='text-sm font-semibold text-gray-800 border border-gray-800 bg-white mt-2 rounded-lg px-4 py-2'>Update Status</button>
          )}
...
export default ShortlistedOrApprovedApplicantCard;
