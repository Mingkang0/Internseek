        ...
        <div className='col-span-4 lg:col-span-8'>
          ...
          <div className='flex flex-col lg:flex-row gap-2 lg:gap-8 mt-2'>
            ...
            <div className='flex flex-col SAL'>
              ...
              <a id={`student-application-letter-download-${application.student.id}`} href={`/storage/InternshipApplication/documents/SAL/${application.student.id}/${application.SAL}`} target="_blank" style={{ display: 'none' }} />
              <button
                onClick={(e) => {
                  e.preventDefault();
                  document.getElementById(`student-application-letter-download-${application.student.id}`).click();
                }}
                className='text-sm font-semibold text-white mt-2 bg-blue-800 px-4 py-2 rounded-lg lg:w-40 h-10'>
                View SAL
                </button>
          ...
          </div>
          {
            application.reasonRejected && (
              <div className='flex flex-col gap-2 mt-2'>
                ...
                <textarea className='mt-2 border border-gray-300 bg-gray-100 rounded-lg mr-12 w-full lg:w-96' rows={4} value={application.reasonRejected} disabled />
              </div>
            )
          }
        </div>

        <div className='col-span-4 lg:col-span-2 flex flex-col justify-end gap-4 mt-4 lg:mt-0'>
