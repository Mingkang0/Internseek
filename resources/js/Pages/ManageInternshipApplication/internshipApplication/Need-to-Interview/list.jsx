...
export default function InterviewApplicantList({ applications }) {
  ...
  const itemsPerPage = 5; // Change this value to control the number of items per page
  ...
  // Calculate the current applications based on the current page
  ...
  return (
    <DefaultLayout>
      <div className='bg-gray-200 px-6 py-4 min-h-screen mx-auto overflow-y-auto lg:py-4'>
        <Head title='Need-to-Interview List' />
        <div className='container mx-auto'>
          <h3 className="text-xl font-bold text-gray-800">Need-to-Interview List ({filteredApplications.length})</h3>
            ...
            <div className='flex flex-col lg:flex-row lg:justify-end mt-2 gap-4 lg:mt-0'>
              ...
              <div>
                <input
                  ...
                  className="bg-white border border-gray-300 text-gray-900 w-full lg:w-56 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block p-2.5"
                />
              </div>
            </div>
            <div className="mt-4">
