      ...
      <form>
        ...
        <div className="grid grid-cols-12 mt-4 gap-6">
          ...
          <div className="col-span-4">
            ...
            <select id="branch" disabled className="mt-2 block w-full px-3 py-2 bg-gray-200 border border-gray-100 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
              <option selected>Select Branch</option>
            </select>
          </div>
          <div className="col-span-4">
            <label className="block text-sm font-medium text-gray-700">Site</label>
            <select id="site" disabled className="mt-2 block w-full px-3 py-2 bg-gray-200 border border-gray-100 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
