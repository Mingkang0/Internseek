          ...
          <div className="mx-auto mt-8">
            <table className="border border-gray-900 w-full text-sm text-left rtl:text-right text-gray-500 overflow-x-auto lg:overflow-x-none">
              <thead className="text-xs text-gray-700 uppercase bg-gray-300 border-b border-gray-900 text-center">
                <tr>
                  <th scope="col" className="px-6 py-3 border-r border-gray-900">No.</th>
                  <th scope="col" className="px-6 py-3 border-r border-gray-900">Company Name</th>
                  <th scope="col" className="px-6 py-3 border-r border-gray-900">Business Registration No.</th>
                  <th scope="col" className="px-6 py-3 border-r border-gray-900">Business Registration Date</th>
                  <th scope="col" className="px-6 py-3 border-r border-gray-900">Rating</th>
                  <th scope="col" className="px-6 py-3 border-r border-gray-900">Company Email</th>
                  <th scope="col" className="px-6 py-3 border-r border-gray-900">Action</th>
                </tr>
              </thead>
              <tbody>
                {currentCompanies.map((company, index) => (
                  ...
                  >
                    ...
                    <td className="px-4 py-4 whitespace-nowrap border-r border-gray-900">{company.companyName}</td>
                    <td className="px-4 py-4 whitespace-nowrap border-r border-gray-900">{company.businessRegNum}</td>
                    <td className="px-4 py-4 whitespace-nowrap border-r border-gray-900">{company.businessRegDate}</td>
                    <td className="px-4 py-4 whitespace-nowrap border-r border-gray-900">{company.companyRating}</td>
                    <td className="px-4 py-4 whitespace-nowrap border-r border-gray-900">{company.companyEmail}</td>
                    <td className="px-4 py-4 whitespace-nowrap border-r border-gray-900">
                      <a
