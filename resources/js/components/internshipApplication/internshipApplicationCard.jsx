    ...
    <div className="w-full p-5 mt-2 bg-white border border-gray-200 rounded-lg shadow">
      ...
      <div className="flex justify-between gap-4">
        ...
        <div className='flex flex-col justify-end gap-4'>
          ...
          <button type='button' onClick={handleUpdateStatus} className='text-sm font-semibold text-gray-800 border border-gray-800 bg-white mt-2 rounded-lg px-4 py-2'>Update Status</button>
        </div>
      </div>
