...
const CompanyCard = ({ employer }) => {
  return (
    <div className="flex-grow min-h-full w-full my-6">
      <div className='h-full bg-white border border-gray-200 rounded-lg shadow p-4'>
        <div className="grid grid-cols-4 gap-8">
          <div className="col-span-1">
            <img src="../../assets/avatar.png" alt="CompanyLogo" className="w-50 h-50 rounded-full mx-auto border ring-1 ring-gray-900" />
          </div>
        ...
        <div>
          ...
          <div className='company-attributes flex justify-between'>
